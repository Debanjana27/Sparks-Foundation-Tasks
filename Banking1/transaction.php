...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
	...
	<?php
$IIFSC=$_GET['RECIEVER'];
$sql="SELECT * FROM `customers_table` WHERE `IIFSC`='$IIFSC'";
...
<form method="POST" action="transaction.php">
	...
	<tr>
	<th>Email</th>
	<td><input type="number" name="Email" value=<?php echo $data['Email']; ?> required></td>
	</tr> 
	<tr>
	<th>Account balance</th>
	<td><input type="number" name="sem" value=<?php echo $data['Account balance']; ?> required></td>
	</tr>
