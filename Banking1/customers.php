...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
	...
	<tr style="background-color:#211969;color:#fff">
		<th>Name</th>
    ...
    <?php
	include('database.php');
    $sql=mysqli_query($con,"Select * from customers_table");
	...
	?>
         <tr align="center">
         	     ...
         	     <td><?php echo $result['Account number'];?></td>
				 <td><?php echo $result['IIFSC'];?></td>
         	     <td><?php echo $result['Email'];?></td>
         	     <td><?php echo $result['Account balance'];?></td>
                        ...
                        <div class="footer-address mt-40">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="cont">
                                        <p>Our place, MONEY2SEND group</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
...
<!-- Mirrored from wpsprite.com/html/edubin/contact-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2019 16:02:17 GMT -->
</html>
